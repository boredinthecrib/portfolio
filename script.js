...
window.onload = () => {
  ...
  function animateOnScroll() {
    const animElements = document.querySelectorAll(
      ".project, .skill-category, #contact, #about, #Resume"
    );
  ...
  const sections = document.querySelectorAll(
    ".skill-category, #contact, #about, #Resume"
  );
  ...
  if (contactForm) {
    contactForm.addEventListener("submit", function (event) {
      ...
      alert(
        `Thanks for your message, ${name}! I'll get back to you at ${email} soon.`
      );
